...
def MinimalJobshopSat():
    ...
    jobs_data = [  # task = (machine_id, processing_time).
        [(0, 3), (1, 2), (2, 2),(3, 4),(4, 1),(5, 3),(6, 2)],  # Job0 seria el trabajo necesario para hacer un helado
        [(0, 2), (2, 1), (1, 4),(3,2)],  # Job1
        [(1, 4), (2, 3),(6,1)]  # Job2
    ]

    Maq_helado=['Mezcladora','Pasteurizadora','Maduradora','Mantecadora','Envasadora','Batidora','Conservadora']
    ...
    for machine in all_machines:
        ...
        sol_line_tasks =Maq_helado[machine] + ': '
        sol_line = '           '
